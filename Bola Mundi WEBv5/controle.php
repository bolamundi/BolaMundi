...
<div class="content">
			...
			<table>
<tr><th>Id</th><th>Nome</th><th>Email</th><th>Senha</th><th>Acesso</th><th>Status</th><th>Data de cadastro</th><th colspan="3">Ações</th></tr>
				
<?php
	  while($row = $result->fetch_assoc()) {
		echo "<tr><td>" . $row["Id"] . "</td><td>" . $row["Nome"] . "</td><td>" . $row["Email"] . "</td><td>" . $row["Senha"] . "</td><td>" . $row["Acesso"] . "</td><td>" . $row["Status"] . "</td><td>" . $row["Data"] . "</td>";
...
<script src="js/controleusuario/chartcontrole.php"></script>



<script src="js/controleusuario/chartcadastroporsemana.php"></script>
</body>
</html>
<?php
