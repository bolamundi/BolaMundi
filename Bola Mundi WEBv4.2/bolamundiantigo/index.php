                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-12">
                            <div class="heroText">
                                <h1 class="text-white mb-lg-5 mb-4">Bola Mundi</h1>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="pricing-plan bg-white">
                                <div class="d-flex flex-wrap align-items-center pricing-header">
                                    ...
                                    <small class="pricing-recommend">Atualizada</small>
                                       ...
                                       <div id="wg-api-football-livescore" data-host="v3.football.api-sports.io" data-refresh="60" data-key="52bdc83e957e93a6343e282ebcf1ff57" data-theme="dark" data-show-errors="false" class="api_football_loader">
