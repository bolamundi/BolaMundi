    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div id="modal01" class="w3-modal w3-animate-zoom w3-center" onclick="this.style.display='none'">
            <img class="w3-modal-content" src="ranks/ranks.jpg" alt="Nature and sunrise">
        </div>
    	...
    	<div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      		...
      		<form class="w3-container" action="trocaremail.php?id=<?php echo $id_usuario?>" method="post">
        		<div class="w3-section">
          			...
          			<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="Insira seu e-mail novo" name="novoemail" required>          
          			<input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="Insira sua senha" name="senha" required>
    	...
    	<div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      		...
      		<form class="w3-container" action="trocarsenha.php?id=<?php echo $id_usuario?>"  method="post">
        		<div class="w3-section">
          			...
          			<input class="w3-input w3-border w3-margin-bottom" type="password" placeholder="Insira sua nova senha" name="novasenha" required>
          			<button class="w3-button w3-block w3-red w3-section w3-padding" type="submit">Enviar</button>
        		</div>
      		</form>          
		</div>
