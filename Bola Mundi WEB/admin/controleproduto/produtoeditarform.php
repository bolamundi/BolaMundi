...
<html>
 ...
 <body>
   ...
   <div class="container">
       ...
       <form action="produtoeditar.php" style ="margin-left: 50%; margin-top: 10%;">
		...
		<label for="email">Número de vendas</label></label>
		<input type="text" id="email" name="numero_vendas" value="<?php echo $row["Numero_vendas"]; ?>" placeholder="Preencha o número de vendas">
