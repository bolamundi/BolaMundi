  ...
  $tempoRestante=24 - floor($proxRecompensa/3600);}
      ...
      while($row = $res->fetch_assoc()){
          if(isset($_SESSION['nome']) and $row["Nome"]==$_SESSION['nome']){
            ...
            echo "<div class='coments' > <h4>" . $row["Nome"] . "<a type='button' href='excluircomentario.php?id=". $row["Id"] ."&idsel=". $idsel ."' >Excluir</a></h4>" . " <p>" . $row["Comentario"] . "</p> <p>" . $row["Data"] . " </p> <br><br> </div>";
          }else{
