    ...
    <body data-spy="scroll" data-target="#main-navbar">
        ...
        <div class="body">
                  ...
                  <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a class="page-scroll" href=historiadacopa/historiadacopa.php>História da Copa</a></li>
                            ...
                            <li><a class="page-scroll" href="friendsarena/friendsarena.php">Friends Arena</a></li>
            ...
            <div class="w3-bar w3-border-bottom">
                <button class="tablink w3-bar-item w3-button" onclick="openPerfil(event, 'Usuário')">Usuário</button>
                ...
                <div class="container">
                    <div class="caption text-center text-white" data-stellar-ratio="0.7">
                        ...
                        <div id="owl-intro-text" class="owl-carousel">
                            <div class="item">
                                <h1>BEM-VINDO(A) AO BOLA MUNDI <?php echo $recepcao; ?>!</h1>
                            </div>
                                ...
                                <div class="item">
                                    <blockquote>
                                        <div class="selecoescarousel">
                                          ...
                                          <a href="selecoes/selecao.php?idsel=1"><button type="submit" class="selecoes-inner" style="color: #FFFFFF">Clique Aqui</button></a>              
                                        </div>
                                    </blockquote>
                                </div>
                                <div class="item">
                                    <blockquote>
                                        <div class="selecoescarousel">
                                          ...
                                          <button type="submit" class="selecoes-inner">Clique Aqui</button>        
                                        </div>
                                    </blockquote>
                                </div>
                                <div class="item">
                            ...
                            <div class="col-sm-6">
                                <div class="contact-form">
                                    ...
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control input-lg" placeholder="Seu E-mail" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control input-lg" placeholder="Cabeçalho" required>
                                        </div>
                                        <div class="form-group">
